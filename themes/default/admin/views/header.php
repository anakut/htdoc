                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_products">
                                ...
                                <ul>
                                    ...
                                    <li id="products_quantity_adjustments" class="">
                                ...
                                <ul>
                                    <li id="transfers_index"  class="">
                                        <a class="submenu" href="<?= admin_url('transfers'); ?>">
                                            <i class="fa fa-table"></i><span class="text"> <?= lang('list_transfers'); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li id="transfers_purchase_by_csv" class="">
