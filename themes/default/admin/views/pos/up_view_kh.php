...
<div id="wrapper">
    ...
    <style type="text/css">
        ...
        <div class="text-center">
            ...
            // echo "</div>";
//reciept
            echo "<div class='pull-right' style='front-size:12px !important;text-align:left;'>";
            echo "<span style='font-size:12px !important;font-family: Khmer OS ;' >ថ្ងៃខែឆ្នាំ</span>";
        
            echo "<span style='font-size:12px !important;font-family: Khmer OS ;'>&nbsp; : &nbsp;".$newDate."</span>"."<br>";
                echo "<span style='font-size:12px !important;font-family: Khmer OS ;'>វិក័យបត្រ</span>";
                echo "<span style='font-size:12px !important;'>&nbsp; : &nbsp;".$inv->reference_no."<span>"."<br>";
                echo "<span style='font-size:12px !important;font-family: Khmer OS ;'>អតិថិជន</span>";
                echo "<span style='font-size:12px !important;font-family: Khmer OS ;'>&nbsp; : &nbsp;&nbsp;".$customer->name."<span>"."<br>";
                echo "<span>លេខទូរស័ព្វ</span>";
                echo "<span style='font-size:12px !important;font-family: Khmer OS ;'>&nbsp; : &nbsp;".$customer->phone."</span>"."<br>";
               // echo "<span>អាស័យដ្ធាន</span>";
               // echo "<span style='font-size:12px !important;font-family: Khmer OS ;'>&nbsp; : &nbsp;".$customer->address."</span>";
            echo "</div>";
            ?>
            <style type="text/css">
                #tbl-con thead tr td{
            ...
            <table class="table table-striped table-condensed" id="tbl-con" style="margin-top: 9px;">
                <thead style="border-top: 2px;">
                    <tr style="border-top: 1px solid black !important;">
                        <td colspan="5" style="border-bottom: 1px solid black !important;border-left: 1px solid black !important;text-align: left;font-size: 9px !important;white-space: nowrap;font-family: kh_new ;">ទំនិញ / Description</td>
                        ...
                        center;font-family: kh_new ;">Dis.</td>
                        <td style="width: 100px !important;border-bottom: 1px solid black !important;font-size: 9px !important;text-align: 
                        right;font-family: kh_new ;">ចំនួន / Quantity</td>
                        <td style="width: 100px !important;border-bottom: 1px solid black !important;font-size: 9px !important;text-align: right;font-family: kh_new ;">តម្លៃរាយ / Unit Price</td>
                        <td style="width: 100px !important;border-bottom: 1px solid black !important;border-right: 1px solid black !important;font-size: 9px !important;text-align: right;font-family: kh_new ;">សរុប / Amount</td>
                    ...
                    echo '<tr>';
                        ...
                        if ($row->discount != 2) { 
                           ...
                           echo '<td text-align:center;>0%</td>';
                            ...
                            //     echo '<td>0%</td>';
                            // }
                            echo '<td class="text-center" style="white-space:nowrap; font-size:14px; border: 1px  black !important;font-family: Khmer OS ;">'.
                            number_format($row->quantity,0).'</td>';
                            echo '<td style="white-space:nowrap !important; text-align: right;border: 1px  black !important;font-family: Khmer OS ;font-size:14px;">'.number_format($row->real_unit_price + ($row->item_tax / $row->quantity),0).'</td>';
                            echo '<td style="white-space:nowrap !important; text-align: right;border: 1px  black !important;font-family: Khmer OS ;font-size:14px;">'.number_format($row->quantity*($row->real_unit_price + ($row->item_tax / $row->quantity)),0).'</td>';
                ...
                <tr style="padding-top: 20px !important;">
                    ...
                    <th class="" colspan="5" style="white-space: nowrap !important;border-left: 1px solid black !important;border-top: 1px solid black !important; border-bottom: 1px solid black !important; font-size: 14px;font-family: kh_new;"><?= lang("សរុបចុងក្រោយ / Grand Total");?>
                    </th>
                  
                    <th colspan="2" class="text-right   " style="white-space: nowrap !important;border-top: 1px solid black !important; border-bottom: 1px solid black !important;  font-size: 14px;">$ <?=number_format((($inv->total)/($rate->rate)),2); ?>
                    </th>
                    <th colspan="2" class="text-right" style="white-space: nowrap !important;border-right: 1px solid black !important;border-top: 1px solid black !important; border-bottom: 1px solid black !important;font-size: 14px;">R <?= number_format(($inv->total + $inv->product_tax),0); ?>
                </tr>
                <tr style="padding-top: 20px !important;">
                  ...
                  <th colspan="2" class="notbold" style="white-space: nowrap !important; font-size: 14px;">$ <?=number_format(($paid_amount/($rate->rate)*1000),2) ; ?>
                  </th>
                  <th colspan="2" class="notbold" style="white-space: nowrap !important; font-size: 14px;">R <?= number_format($paid_amount*1000,0)?>
              </tr>
              <tr style="padding-top: 20px !important;">
                  ...
                  <th colspan="2" class="notbold" style="white-space: nowrap !important;border-top: 1px dotted black !important; border-bottom: 1px dotted black !important; font-size: 14px;">$ <?= number_format(($p_balance_r)/($rate->rate)*1000,2)?>
                  </th>
                  <th colspan="2" class="notbold" style="white-space: nowrap !important;border-top: 1px dotted black !important; border-bottom: 1px dotted black !important; font-size: 14px;">R <?= number_format($p_balance_r*1000,0) ;?>
              </tr>
              <tr style="padding-top: 20px !important;">
                
                <th class="" colspan="5" style="white-space: nowrap !important; border-top: 1px dotted black !important;border-bottom: 1px solid black !important;font-size: 14px;font-family: kh_new;"><?= lang("Discount សរុប");?>
                </th>
              
                <th colspan="2" class="notbold" style="white-space: nowrap !important;border-top: 1px dotted black !important; border-bottom: 1px solid black !important; font-size: 14px;">$ <?=number_format(($inv->order_discount+$dis)/($rate->rate),2)?>
                </th>
                <th colspan="2" class="notbold" style="white-space: nowrap !important;border-top: 1px dotted black !important; border-bottom: 1px dotted black !important; font-size: 14px;">R <?= number_format($dis+$inv->order_discount,0) ;?>
            </tr>
                <?php
            ...
            <div class="well well-sm" style="text-align:center; margin-top:-50px; border:none; background:none; font-size:11px;">
