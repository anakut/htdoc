            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        // , 'combo' => lang('combo'), 'digital' => lang('digital'), 'service' => lang('service')
                     ...
                     <div class="form-group">
                        <table id="tbSale_type" class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="edit_data">
                                        <td><input type="text" class="form-control" name="type_sale[]" value="<?php echo $row->sale_unitname?>" readonly></td>
                                        <td><input type="text" class="form-control" name="price_unit[]" value="<?php echo number_format($row->sale_unitprice,2)?>"></td>
                                        <td><i class="fa fa-times tip del" title="Remove"></i></td>
                                    </tr>
                                <?php
                                } ?>
                            </tbody>
